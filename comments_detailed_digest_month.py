...
if comments_results:                                    # if table give comment tuples: (('-80849532', 14, 7.0), ('100072457', 1, 0.0))
    for item in comments_results:                       # For each item in tuple of tuples: ('-80849532', 14, 7.0)
        ...
        if likes_count > 0:
            ...
            if user_rating and comm_count > 20:
...
wiki_msg = "[[photo-46631810_395391493|600px;noborder| ]] \n" \
           "=== Таблица комментаторов за месяц ===\n" \
...
group = '46631810'
# Таблица рейтинга подробная комментаторы (месяц)
# https://vk.com/page-46631810_49912969
page = '49912969'

print("Post data to wiki page https://vk.com/page-46631810_49912969")
